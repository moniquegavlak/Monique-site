...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 md:py-32 z-10 relative bg-bg-warm-1 text-text-main border-y border-terracotta/10">
      ...
      <div className="space-y-0 border-t border-text-muted/20 bg-bg-body w-full">
        {t.services.items.map((service, idx) => (
          <motion.div 
            ...
            className="border-b border-text-muted/20 py-10 md:py-16 px-6 md:px-12 group hover:bg-bg-warm-2 md:hover:px-16 transition-all duration-500 cursor-[crosshair] w-full"
          >
            <div className="max-w-[1600px] mx-auto grid md:grid-cols-12 gap-6 items-start">
